...
// จุดสีหน้าเส้นคั่นบน-ล่าง (ดู framedMessage()) แยกตาม "กองที่รับผิดชอบ" ให้เจ้าหน้าที่กวาดตาหางานของกองตัวเอง
...
// ประกอบข้อความทั้งใบ: เส้นคั่นสีกอง / <อีโมจิ> <หัวเรื่อง> / เนื้อหา / เส้นคั่นสีกอง
...
function framedMessage(resource: Record<string, unknown>, emoji: string, title: string, body: string[]) {
  const band = departmentColor(resource) + RULE_DASH.repeat(RULE_DASH_COUNT)
