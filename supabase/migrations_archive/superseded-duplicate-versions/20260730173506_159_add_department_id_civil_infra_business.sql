-- 159_add_department_id_civil_infra_business.sql
...
--
-- หมายเหตุ: backfill จาก schema จริงบน Supabase ย้อนหลัง (apply ตรงผ่าน Supabase MCP ตอนพัฒนา
-- ฟีเจอร์ ไม่ได้มีไฟล์ migration ในโปรเจกต์ตั้งแต่แรก)
