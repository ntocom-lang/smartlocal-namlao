-- ปักหมุดจุดรับผู้ป่วย (ทางเลือก) — เฟสที่ 2: RPC ที่อ้างคอลัมน์จาก 20260919120000
--
-- ยกฟังก์ชันเดิมมาทั้งตัวแล้วแก้เฉพาะจุด (ห้าม placeholder ใน CREATE OR REPLACE — ดู NOTES)
-- workspace: แถวของเจ้าหน้าที่/ผู้จองใช้ to_jsonb(r) จึงได้คอลัมน์ใหม่เอง ส่วน projection ของ
-- คนขับระบุช่องเอง ต้องเติม pickup_lat/pickup_lng ไม่งั้นคนขับกดนำทางไม่ได้
BEGIN;
