...
--
-- ⚠️ ผลที่ยอมรับแล้ว: เจ้าหน้าที่ที่มีแต่คำร้องเฉพาะกิจค้างอยู่ จะลบบัญชีได้ โดยคำร้องเหล่านั้น
-- ยังชี้ไปที่ profile ที่ถูกลบ — ป้องกันด้วยด่านแรกของ delete_user_by_id ที่ยังบล็อกอยู่เหมือนเดิม
-- (ห้ามลบถ้ายังเป็น "ผู้รับผิดชอบเริ่มต้น" ใน category_assignments ซึ่งหมวดกลิ่นมีผูกไว้อยู่แล้ว)
-- แอดมินจึงยังถูกบังคับให้โอนงานก่อนอยู่ดีในทางปฏิบัติ
