-- 157_data_center_unified_pins_add_route.sql
-- เพิ่ม route_points/route_color เข้า data_center_unified_pins ให้แผนที่ดึงเส้นทาง (ถนนสายหลัก ฯลฯ)
-- ที่กรอกในศูนย์ข้อมูลดิจิทัลไปแสดงเป็นเส้นได้ — มีค่าเฉพาะ data_center_entries เท่านั้น
-- แหล่งข้อมูลอื่น (คำร้อง/สถานประกอบการ/ฯลฯ) เป็น null เสมอเพราะไม่มีแนวคิดเส้นทางแบบนี้
-- ต้อง DROP ก่อน CREATE เพราะ Postgres ไม่ให้เปลี่ยนรายการคอลัมน์ของ RETURNS TABLE ด้วย CREATE OR REPLACE
