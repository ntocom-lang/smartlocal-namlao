...
const PLAN_FIXES = {
  ...
  'ต้องตรวจสอบพื้นที่รับบริการ': 'ประชาชนไม่ได้รับรองข้อนี้เอง เจ้าหน้าที่เป็นผู้ตรวจ · ตรวจจุดรับข้างบนแล้วกดปุ่ม “ตรวจแล้ว อยู่ในเขตพื้นที่” ด้านล่างนี้ ยืนยันเฉพาะเมื่อตรวจแล้วจริง',
