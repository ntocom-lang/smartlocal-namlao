...
export default function ChatbotPage() {
  ...
  const handleSend = async (e) => {
    ...
    // จำลอง AI แบบ Mock-up ตามคำขอ
    setTimeout(() => {
      let reply = 'ตอนนี้น้องสมายล์เป็นเพียงระบบจำลองนะคะ อาจจะยังไม่เข้าใจคำถามทั้งหมด ลองพิมพ์คำว่า "ขยะ", "เอกสาร", "ร้องเรียน", หรือ "สภาพอากาศ" ดูสิคะ 🦖';
