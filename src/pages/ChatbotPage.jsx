  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      if (text.includes('สวัสดี') || text.includes('ทักทาย') || text.includes('ดีจ้า') || text.includes('หวัดดี')) {
        ...
        reply += 'เรื่องขยะ แจ้งได้เลยครับ! สามารถไปที่เมนู "แจ้งเหตุ/แจ้งซ่อม" แล้วเลือกหมวดหมู่ "ขยะ / ความสะอาด" ได้เลยนะครับ 🤖';
        ...
        reply += 'พบเจอปัญหาเดือดร้อน แจ้งเราได้ทันทีครับ! กดที่ปุ่ม "แจ้งเหตุ/แจ้งซ่อม" บนหน้าแรก เจ้าหน้าที่จะรับเรื่องและแก้ไขให้ไวที่สุดครับ 🤖';
