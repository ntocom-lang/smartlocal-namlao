  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      if (text.includes('สวัสดี') || text.includes('ทักทาย') || text.includes('ดีจ้า') || text.includes('หวัดดี')) {
        ...
        reply += 'เรื่องขยะ แจ้งได้เลยครับ! สามารถไปที่เมนู "ร้องเรียน/ร้องทุกข์" แล้วเลือกหมวดหมู่ "ขยะ / ความสะอาด" ได้เลยนะครับ 🤖';
        ...
        reply += 'แหล่งท่องเที่ยว ที่พัก ร้านอาหาร ร้านค้า และบริการในพื้นที่ ดูได้ที่หมวด "เที่ยว กิน พัก ชอป บริการ" หน้าแรกเลยครับ 🤖';
      } else {
