...
const DOC_TYPES = [
  ...
  {
    value:   'tax_notice',
    label:   'ขอรับใบแจ้งชำระภาษีที่ดิน',
    emoji:   '📋',
    desc:    'ขอรับใบแจ้งภาษีที่ดินและสิ่งปลูกสร้างประจำปี',
    color:   '#d97706',
    bg:      '#fffbeb',
    border:  '#fde68a',
  },
  {
    ...
    label:   'ขอรับใบแจ้งค่าเก็บขยะ',
    emoji:   '🗑️',
    desc:    'ขอรับใบแจ้งค่าธรรมเนียมเก็บและขนขยะมูลฝอย',
    color:   '#0891b2',
    bg:      '#ecfeff',
    border:  '#a5f3fc',
  },
