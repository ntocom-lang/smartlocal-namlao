              ...
              <div className="bg-gray-50 rounded-2xl divide-y divide-gray-100 overflow-hidden">
                {(c.location_name || c.village) && (
                  <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] text-gray-400">สถานที่เกิดเหตุ</p>
                ...
                {c.latitude && (
                  <a href={`https://maps.google.com/?q=${c.latitude},${c.longitude}`}
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] text-gray-400">พิกัดสถานที่</p>
                  ...
                  <a key={i} href={url} target="_blank" rel="noreferrer"
                    ...
                    {/\.(jpg|jpeg|png|gif|webp)$/i.test(url) ? (
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-[9px] text-gray-400">ไฟล์</span>
                      </div>
                    )}
                  </a>
                ))}
