...
export default function ReferralPartnersCard({ tenant }) {
  ...
  <Link to="/staff/patient-transport" className="inline-flex min-h-11 items-center rounded-xl bg-sky-50 px-3 py-2 text-sm font-semibold text-sky-800">ตั้งค่าระบบจองรถ / จัดคิวแทนกองทุน</Link>
      )}
