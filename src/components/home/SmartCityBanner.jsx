...
// ไม่ใช้ภาพสำเร็จรูป/ภาพสต็อกจากที่ไหนเลย เนื้อหา/ลิงก์ชี้ไปที่ระบบ GIS ของเราเองที่มีจริง — พาไปหน้า GIS Portal (/data-center) ให้ผู้ใช้เลือกฝั่งประชาชน/เจ้าหน้าที่เอง
//
