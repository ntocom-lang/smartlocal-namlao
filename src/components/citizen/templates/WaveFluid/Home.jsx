...
const BASE_DOC_TYPES = [
  { value: 'residence_cert',   label: 'ใบรับรองการอยู่อาศัย',           emoji: <Home size={30} strokeWidth={2.5} className="text-white drop-shadow-md" /> },
  { value: 'personal_cert',    label: 'หนังสือรับรองบุคคล',              emoji: <User size={30} strokeWidth={2.5} className="text-white drop-shadow-md" /> },
  { value: 'conduct_cert',     label: 'หนังสือรับรองความประพฤติ',        emoji: <FileCheck size={30} strokeWidth={2.5} className="text-white drop-shadow-md" /> },
  { value: 'tax_notice',       label: 'ชำระภาษีที่ดินและสิ่งปลูกสร้าง', emoji: <Landmark size={30} strokeWidth={2.5} className="text-white drop-shadow-md" /> },
  ...
  { value: 'other',            label: 'คำขออื่นๆ',                       emoji: <FileText size={30} strokeWidth={2.5} className="text-white drop-shadow-md" /> },
]
