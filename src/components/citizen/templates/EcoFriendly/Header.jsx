      ...
      <div className="text-white px-4 relative overflow-hidden"
        ...
        <div className="max-w-6xl mx-auto flex items-center gap-3 relative z-10">
          ...
          {session ? (
            ...
            <Link to="/auth"
              className="hidden lg:flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-bold bg-white/20 hover:bg-white/30 text-white transition-colors border border-white/20">
