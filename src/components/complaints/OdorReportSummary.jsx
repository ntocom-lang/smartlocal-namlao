...
//
// ไม่มีข้อมูลผู้แจ้งในแผงนี้เลยแม้แต่ช่องเดียว (ชื่อ/เบอร์/รายละเอียดที่พิมพ์เอง) — เป็นสถิติรวมล้วน
// ใครเห็นแผงนี้จึงไม่ได้เห็น PII เพิ่มจากที่ role ตัวเองเห็นอยู่แล้ว
