// หัวเรื่องของหน้าโมดูล — ตัวเดียวใช้ทั้งหน้าเจ้าหน้าที่และแผงควบคุมผู้ดูแลระบบ
//
...
// eyebrow — บอกว่ากำลังอยู่ในส่วนไหนของระบบ (กติกา 3 ส่วน: แอดมิน / เจ้าหน้าที่ / ประชาชน)
// คนที่มีสิทธิ์สลับไปมาได้ทั้ง 2 ส่วนต้องรู้ว่าตอนนี้อยู่ฝั่งไหน เพราะเมนูชื่อคล้ายกันหลายเมนู
export default function ModuleHeader({ Icon, label, desc, color, eyebrow = 'ระบบเจ้าหน้าที่' }) {
