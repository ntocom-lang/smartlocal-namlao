...
const citizen = [
  ['home', 'กดขอจองรถ', 'ปุ่ม “ขอจองรถรับส่ง” อยู่บนสุดของหน้า ฟอร์มจบในหน้าเดียว เลื่อนกรอกรวดเดียวแล้วกด “ส่งคำขอจองรถ” ปุ่มเดียวที่ล่างสุด ถ้ายังกรอกไม่ครบ ระบบจะบอกเป็นรายการว่าขาดอะไรและต้องทำอย่างไร'],
  ['home', 'เลือกวันและเวลาจากปุ่ม', 'วันที่ไปโรงพยาบาลเลือกจากปุ่มวันที่ว่างจริง ระบบเลือกวันที่จองได้เร็วที่สุดไว้ให้ก่อนแล้ว ถ้าวันนัดเป็นวันอื่นให้กด “เลือกวันอื่น” เวลานัดเลือกจากรายการเวลาไทยซึ่งมีเฉพาะช่วงที่รถไปส่งทัน ชื่อกับเบอร์เติมมาจากบัญชีของคุณแล้ว แก้ได้'],
  ['calendar', 'ดูว่าวันไหนจองได้', 'ปุ่ม “ดูวันว่าง” เปิดตารางรถ กล่องบนสุดบอกวันที่จองได้เร็วที่สุดพร้อมปุ่มจองทันที ด้านล่างเป็นรายการเฉพาะวันที่จองได้หรือขอนั่งไปด้วยได้ วันที่จองไม่ได้ยุบไว้ใต้ “วันที่จองไม่ได้” กดดูได้'],
  ['calendar', 'ขอนั่งรถเที่ยวที่มีอยู่แล้ว', 'เที่ยวที่ขึ้นว่า “ขอนั่งไปด้วยได้” ให้กด “ขอนั่งรถคันนี้ไปด้วย” แล้วกรอกข้อมูลตามจริง คำขอนี้ยังไม่กันที่นั่ง ต้องรอเจ้าหน้าที่ยืนยันก่อนเดินทาง'],
  ['mine', 'ติดตามผลและเวลารับ', '“การจองของฉัน” อยู่ใต้ปุ่มในหน้าเดียวกัน ป้ายสีบอกสถานะของแต่ละคำขอ ตรวจว่าขึ้นยืนยันรถแล้ว ดูเวลาเริ่มรับและประกาศล่าช้าล่าสุด เวลาที่แสดงเป็นประมาณการ เจ้าหน้าที่จะประสานจุดรับ'],
